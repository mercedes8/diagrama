    ...
    <div style={S.app}>
        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: 12, color: "#64748b", marginBottom: 8 }}>
              Confirmá o ajustá las horas objetivo de cada empleado antes de
              armar el diagrama.
            </div>
            {(() => {
              const wd = calcWorkingDays(year, month, holidays);
      ...
      <div style={S.hdr} className="no-print">
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          <button style={S.btn("#059669")} onClick={exportExcel}>
            📊 Excel
          </button>
          <button style={S.btn("#4f46e5")} onClick={exportPDF}>
            🖨️ PDF
          </button>
          <button
            onClick={handleSave}
        ...
        {tab === "schedule" && (
          <>
            ...
            {showAlerts && alerts.length > 0 && (
              <div style={{ marginBottom: 10 }} className="no-print">
                ...
                >
                  ...
                  >
                    ⚠️ {alerts.filter((a) => a.type === "danger").length}{" "}
                    críticas ·{" "}
            ...
            >
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    color:
                      filterTurn === k && !filterEmpId ? "#fff" : "#475569",
                    fontSize: 11,
                    fontWeight: 700,
                    cursor: "pointer",
                  }}
              ...
              <button style={S.btn("#f59e0b", "#000")} onClick={doAutoFill}>
                ⚡ Auto-completar
              </button>
              <button style={S.btn("#e2e8f0", "#475569")} onClick={clearAll}>
                🗑️ Limpiar todo
              </button>
              <button
                style={{ ...S.btn("#e0f2fe", "#0369a1"), fontSize: 11 }}
                onClick={() => setHoursReady(false)}
              >
                ⏱ Horas mensuales
              </button>
            </div>
            ...
            >
              ...
              {bulkMode && (
                <>
                  ...
                  >
                    ✅ {bulkSelected.size} celda
                    {bulkSelected.size !== 1 ? "s" : ""} seleccionada
                    {bulkSelected.size !== 1 ? "s" : ""} — hacé clic en las
                    celdas
                  </span>
                  <button
                      ...
                      const turnColor =
                        turn === "TM"
                          ...
                          : turn === "TT"
                            ? "#15803d"
                            : "#111";
                      const allTurnEmps = employees.filter(
                        (e) => e.turn === turn,
                      );
                      return [
                        <tr key={`sep-${turn}`}>
                          ...
                          ? (() => {
                              ...
                              return [
                                ...
                                <tr key="jefe-label">
                                  ...
                                  >
                                    JEFA/E DE SECCIÓN — no incluida en totales
                                    por turno
                                  </td>
                                </tr>,
                                ...
                                >
                                  ...
                                  {dayInfo.map((d) => {
                                    ...
                                    const hasOwnBg =
                                      ["LIC", "EARLY", "LATE", "PM"].includes(
                                        ct,
                                      ) ||
                                      customCellTypes.some((c) => c.key === ct);
                                    const isLAR = larDays.has(k);
                                    const yellowBg =
                                      isYellowCol && !hasOwnBg
                                        ? "#ffff00"
                                        : cs.bg;
                                    const isSelected =
                                      bulkMode && bulkSelected.has(k);
                        ...
                        ...emps.flatMap((emp, empIdx) => {
                          ...
                          const hTrab = (() => {
                            ...
                            return Math.max(
                              0,
                              Math.round(target - horasLicencia),
                            );
                          })();
                              ...
                              >
                                {(() => {
                                  ...
                                  const reduced =
                                    emp.reduction > 0
                                      ? Math.round(
                                          base * (1 - emp.reduction / 100),
                                        )
                                      : base;
                                  const wd = calcWorkingDays(
                                    year,
                                    month,
                                    holidays,
                                  );
            ...
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              ...
              <tbody>
                {employees.map((emp, i) => {
                  ...
                  return (
                    <tr key={emp.id}>
                      <td style={{ ...td, color: "#94a3b8", width: 30 }}>
                        {i + 1}
                      </td>
                      <td style={td}>
                        {isEdit ? (
          ...
          <>
            ...
            <div style={S.cfgBox}>
              <div style={S.cfgTitle}>
                ⏱️ SALIDA ANTICIPADA / TARDÍA — Por turno
              </div>
              <div style={{ fontSize: 11, color: "#64748b", marginBottom: 12 }}>
                La celda rosada indica que el empleado sale <b>antes</b> del
                horario normal, y la verde que sale <b>después</b>. La inicial
                que se muestra siempre corresponde al turno (M / T / N).
              </div>
              <div
            ...
            <div style={S.cfgBox}>
              ...
              <div style={{ fontSize: 11, color: "#64748b", marginBottom: 12 }}>
                Agregá tipos de turno especiales con color, inicial y horas
                propias. Aparecen en el menú contextual (click derecho) de cada
                celda.
              </div>
              <div
                style={{
            ...
            <div style={S.cfgBox}>
              <div style={S.cfgTitle}>
                ⚖️ BALANCE DE HORAS POR TURNO — {MONTHS[month].toUpperCase()}{" "}
                {year}
              </div>
              {["TM", "TT", "TN"].map((turn) => {
                const emps = employees.filter((e) => e.turn === turn);
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <span style={{ fontSize: 11, color: "#475569" }}>
                        Cargadas:{" "}
                        <b style={{ color: diffColor }}>{totalCarg}hs</b>
                      </span>
                      <span
                        style={{
                          fontSize: 11,
            ...
            <div style={{ fontSize: 11, color: "#64748b", marginBottom: 12 }}>
              ...
              <b>sábados tarde/noche</b>. El turno mañana del sábado{" "}
              <b>no cuenta</b> como guardia hospitalaria.
            </div>
            ...
            <div style={S.cfgBox}>
              ...
              <div style={{ fontSize: 11, color: "#64748b", marginBottom: 12 }}>
                ...
                <b>sábados tarde/noche</b>. Turno mañana del sábado{" "}
                <b>no cuenta</b>.
              </div>
              {["TM", "TT", "TN"].map((turn) => {
                const emps = employees.filter((e) => e.turn === turn);
              ...
              {(() => {
                const noCumplen = employees.filter(
                  (e) =>
                    calcGuardiaHospitalaria(schedule, e, dayInfo, daysInMonth) <
                    24,
                );
                return (
                  <div
                    style={{
                      ...
                      padding: "10px 16px",
                      background:
                        noCumplen.length === 0 ? "#f0fdf4" : "#fef2f2",
