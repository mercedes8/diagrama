...
const USERS = [
  ...
  { username: "jefa",     password: "Sabumclaus112715",  role: "Jefa de Servicio", name: "Jefa de Servicio" },
  { username: "enf1",     password: "enfermeria", role: "Enfermería",    name: "Enfermería" },
];
      ...
      <div style={{
        ...
        <div style={styles.form}>
          ...
          <div style={styles.fieldGroup}>
            ...
            <div style={{
              ...styles.inputWrap,
              borderColor: focused === "user" ? "#60a5fa" : error ? "#ef4444" : "#334155",
              boxShadow:   focused === "user" ? "0 0 0 3px rgba(96,165,250,.18)" : "none",
            }}>
          ...
          <div style={styles.fieldGroup}>
            ...
            <div style={{
              ...styles.inputWrap,
              borderColor: focused === "pass" ? "#60a5fa" : error ? "#ef4444" : "#334155",
              boxShadow:   focused === "pass" ? "0 0 0 3px rgba(96,165,250,.18)" : "none",
            }}>
              <span style={styles.inputIcon}>🔒</span>
              <input
                style={styles.input}
        ...
        <div style={styles.footer}>
          <span style={styles.footerDot} /> Acceso restringido al personal autorizado
        </div>
      </div>
...
const styles = {
  ...
  title: {
    ...
    color: "#f0f6ff", lineHeight: 1.1, marginBottom: 6,
  },
  subtitle: {
    fontSize: 12, fontWeight: 600, letterSpacing: 3,
    color: "#60a5fa", textTransform: "uppercase", marginBottom: 24,
  },
  divider: {
    width: "100%", height: 1,
    background: "linear-gradient(90deg, transparent, #1e3a6e 30%, #1e3a6e 70%, transparent)",
  },
  ...
  version: {
    ...
    fontSize: 10, color: "#1e3a6e", fontWeight: 700, letterSpacing: 2,
    fontFamily: "'Barlow Condensed', sans-serif",
  },
};
